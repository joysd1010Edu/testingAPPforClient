      ...
      <div style={{ display: "flex", alignItems: "center", marginBottom: 40 }}>
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M60 70C73 70 80 80 80 90C80 100 73 110 60 110C47 110 40 100 40 90C40 80 47 70 60 70Z"
              fill="#9333EA"
            />
        ...
        <div style={{ marginLeft: 40, fontWeight: "bold", color: "#2563EB" }}>BluBerry</div>
      </div>
      <div style={{ fontSize: 48, color: "#333" }}>Your Trusted Marketplace</div>
    </div>,
